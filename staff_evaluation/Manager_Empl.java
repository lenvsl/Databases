...
import java.math.BigInteger;
public class Manager_Empl extends javax.swing.JFrame {
 ...
 private void DisplayTable()
    {
		...
		try {
			...
			st=myConn.prepareStatement(query);
                        rs = st.executeQuery();
                        jTable_Empl.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jTable_Empl);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manager_Empl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
